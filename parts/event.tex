...
\begin{table}[ht]
\caption[Event spotting using GMM/VSM on CNN (on pre-processed input) CNN features (Basketball dataset) ]{ Precision \& Recall  of GMM/VSM on CNN  features (Basketball dataset)}
